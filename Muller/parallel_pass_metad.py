...
os.chdir(os.getcwd() + '/Documents/TMDmaps')
...
eps_vals = 2.0**np.arange(-10, 4, 0.5) # eps vals unif range is -18 to 4
...
np.save('Error_data_metadynamics_long_beta_0.05_TMDpts.npy', error_data_TMD_FEM)
np.save('Error_data_metadynamics_long_beta_0.05_FEMpts.npy', error_data_FEM_TMD)